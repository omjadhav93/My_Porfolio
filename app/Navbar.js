...
export default function Navbar() {
  ...
  const navbarStyles = {
    ...
    "/Portfolio": "absolute grid grid-flow-col grid-rows-1 gap-8 top-12 left-[50%] translate-x-[-50%]",
    ...
    "/About": "absolute grid grid-flow-col grid-rows-1 gap-8 top-12 left-[50%] translate-x-[-50%]",
  ...
  return (
    ...
    >
      ...
      <Link href="/About" className="inline-block w-max font-semibold text-2xl navitem">About Me</Link>
