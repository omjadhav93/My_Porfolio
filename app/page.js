    ...
    <>
      <PageWrapper>
        <AnimatedSectionWrapper>
          <section className="flex flex-col justify-between relative min-h-screen h-screen px-40 pt-40 pb-20 bg-[#121212]">
            <div className="w-full">
              ...
              <div className="flex flex-row justify-center mt-2 gap-6 opacity-60">
                <LeftIn>
        ...
        <AnimatedSectionWrapper>
          <section id="Portfolio" className="about-me min-h-screen h-screen px-40 pt-28">
            <FadeInOut>
              <div className="font-mono text-lg">.../About me...</div>
            </FadeInOut>
            <div className="flex flex-row w-full mt-2">
              <LeftIn className="flex flex-col gap-1 justify-center flex-grow pr-20 pl-4">
              ...
              <RightIn className="w-1/2 flex flex-row justify-center">
