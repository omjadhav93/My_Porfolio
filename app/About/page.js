...
export default function About() {
  return (
    <>
      <section className="grid grid-cols-[2fr_5fr] gap-4 w-3/4 mx-auto mt-48">
        ...
        <div className="flex flex-col gap-4 ml-20">
          ...
          <a href="/Omkar_Resume.pdf" className="mt-1 w-max outline-none border-none bg-green-700 text-zinc-50 font-semibold text-base px-4 py-2 rounded-lg hover:bg-green-600 active:bg-blue-500" download='Omkar_Resume'>Download CV</a>
        </div>
      </section>
      <Skills size="w-3/4" />
      <Achievements />
